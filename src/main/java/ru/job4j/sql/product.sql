...
begin;
declare pointer SCROLL cursor for select * from products;
fetch last from pointer;
fetch relative -5 from pointer;
fetch relative -8 from pointer;
move relative -5 from pointer;
fetch prior from pointer;
commit;
